...
export default function Footer() {
  return (
    <footer className="w-full border-t border-white/[0.05] bg-nav-bg/50 backdrop-blur-md py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-4 text-left">
            <div className="flex items-center justify-start gap-2 mb-4 group">
              ...
              <span className="text-xl font-bold tracking-tight text-white">Sreyneat<span className="text-accent-blue">.</span></span>
            </div>
          ...
          <div className="col-span-2 md:col-span-1 space-y-4 text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start gap-4">
              <a 
                ...
                className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-text-secondary hover:bg-accent-blue/10 hover:text-accent-blue hover:border-accent-blue/20 transition-all shadow-xl"
              >
                <FaGithub size={18} />
              </a>
              <a 
